...
- SDD-030 最新本地导航决策：顶部青柠栏为左侧圆形日记、居中品牌、右侧圆形头像，个人主页仍只通过头像进入；底部使用浅紫材质并固定为首页、衣橱、中央添加、推荐、资讯五项，所有可见标签统一两个汉字。日记页继续合并日记、收藏、利用率，旧 `/favorites` 重定向到收藏栏。该增量尚未部署，不得写成线上已生效。

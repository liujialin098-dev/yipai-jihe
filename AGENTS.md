...
- 当前阶段：SDD-001、SDD-003、SDD-004 与 SDD-011 已完成；SDD-002 代码、Supabase 配置、自动身份保持验证和邮箱验证均已完成，账号状态修复 Preview 已 READY。下一步由用户本人设置密码并完成退出/重登录，随后更新 SDD-002 为已完成。证据和限制以 [`progress.md`](progress.md) 为准。

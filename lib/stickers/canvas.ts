export const STICKER_CANVAS_THEMES = [
  { value: "lilac", label: "丁香", color: "#d8cbea", text: "#27222d" },
  { value: "lime", label: "青柠", color: "#e5f69b", text: "#24271c" },
  { value: "sky", label: "晴空", color: "#c5e8f7", text: "#20272b" },
  { value: "coral", label: "珊瑚", color: "#ffd0c3", text: "#2e2320" },
  { value: "paper", label: "冷白", color: "#f5f4f2", text: "#252527" },
] as const;
